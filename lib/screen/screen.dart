                ...
                if (snapshot.hasData) {
                  return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                             onTap: () {
          Navigator.push(context,MaterialPageRoute(builder:(context)=>Details(id:reqdata[index].id, catergory:reqdata[index].catergory, productname:reqdata[index].productname, discription:reqdata[index].discription, price:reqdata[index].price, quantity:reqdata[index].quantity, image: reqdata[index].image)));
        },
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.start,
